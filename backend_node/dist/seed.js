...
async function seed() {
    try {
        ...
        await Denomination_1.default.deleteMany({});
        // Insert categories
        ...
        const createdProducts = await Product_1.default.insertMany(productsWithCategory);
        ...
        await Denomination_1.default.insertMany(denominationsWithProduct);
